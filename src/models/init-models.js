...
import _userFood from  "./userFood.js";
...
export default function initModels(sequelize) {
  ...
  const userFood = _userFood.init(sequelize, DataTypes);
  ...
  like_res.belongsTo(userFood, { as: "user", foreignKey: "user_id"});
  userFood.hasMany(like_res, { as: "like_res", foreignKey: "user_id"});
  order_food.belongsTo(userFood, { as: "user", foreignKey: "user_id"});
  userFood.hasMany(order_food, { as: "order_foods", foreignKey: "user_id"});
  rate_res.belongsTo(userFood, { as: "user", foreignKey: "user_id"});
  userFood.hasMany(rate_res, { as: "rate_res", foreignKey: "user_id"});
